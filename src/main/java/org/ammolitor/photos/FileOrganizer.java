...
public abstract class FileOrganizer {
    ...
    protected static final Logger logger = Logger.getLogger("something");

    private File sourceDir;
    private boolean recurseSubdirs;
    private List<File> workFiles = null;

    private final boolean renameOnCollision = true;
    ...
    protected void moveFiles(Iterable<File> files) {
        ...
        TreeMap<File, Integer> movedToDirCount = new TreeMap<>();
